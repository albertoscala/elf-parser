...
namespace elf
{
    using Elf64_Addr    = std::uint8_t[8];  // Unsigned program address
    using Elf64_Off     = std::uint8_t[8];  // Unsigned file offset
    using Elf64_Half    = std::uint8_t[2];  // Unsigned medium integer
    using Elf64_Word    = std::uint8_t[4];  // Unsigned integer
    using Elf64_Sword   = std::uint8_t[4];  // Signed integer
    using Elf64_Xword   = std::uint8_t[8];  // Unsigned long integer
    using Elf64_Sxword  = std::uint8_t[8];  // Signed long integer
